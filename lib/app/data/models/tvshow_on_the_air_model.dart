...
class TvShowOnTheAirModel {
  ...
  factory TvShowOnTheAirModel.fromJson(Map<String, dynamic> json) {
    return TvShowOnTheAirModel(
      id: json['id'] as int? ?? 0,
...
class TvShowOnTheAirResponseModel {
  final int page;
  final List<TvShowOnTheAirModel> results;
  final int? totalPages;
  final int? totalResults;

  TvShowOnTheAirResponseModel({
    required this.page,
  ...
  factory TvShowOnTheAirResponseModel.fromJson(Map<String, dynamic> json) {
    return TvShowOnTheAirResponseModel(
      page: json['page'] as int? ?? 1,
      results: (json['results'] as List<dynamic>?)
              ?.map((item) =>
                  TvShowOnTheAirModel.fromJson(item as Map<String, dynamic>))
              .toList() ??
          [],
