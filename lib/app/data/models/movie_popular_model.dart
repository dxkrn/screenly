...
class MoviePopularResponseModel {
  final int page;
  final List<MoviePopularModel> results;
  final int? totalPages;
  final int? totalResults;

  MoviePopularResponseModel({
    required this.page,
  ...
  factory MoviePopularResponseModel.fromJson(Map<String, dynamic> json) {
    return MoviePopularResponseModel(
      page: json['page'] as int? ?? 1,
      results: (json['results'] as List<dynamic>?)
              ?.map((item) =>
                  MoviePopularModel.fromJson(item as Map<String, dynamic>))
              .toList() ??
          [],
