...
class TvShowPopularModel {
  ...
  factory TvShowPopularModel.fromJson(Map<String, dynamic> json) {
    return TvShowPopularModel(
      id: json['id'] as int? ?? 0,
...
class TvShowPopularResponseModel {
  final int page;
  final List<TvShowPopularModel> results;
  final int? totalPages;
  final int? totalResults;

  TvShowPopularResponseModel({
    required this.page,
  ...
  factory TvShowPopularResponseModel.fromJson(Map<String, dynamic> json) {
    return TvShowPopularResponseModel(
      page: json['page'] as int? ?? 1,
      results: (json['results'] as List<dynamic>?)
              ?.map(
                  (e) => TvShowPopularModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
