...
class TvShowTopRatedModel {
  ...
  factory TvShowTopRatedModel.fromJson(Map<String, dynamic> json) {
    return TvShowTopRatedModel(
      id: json['id'] as int? ?? 0,
...
class TvShowTopRatedResponseModel {
  final int page;
  final List<TvShowTopRatedModel> results;
  final int? totalPages;
  final int? totalResults;

  TvShowTopRatedResponseModel({
    required this.page,
  ...
  factory TvShowTopRatedResponseModel.fromJson(Map<String, dynamic> json) {
    return TvShowTopRatedResponseModel(
      page: json['page'] as int? ?? 1,
      results: (json['results'] as List<dynamic>?)
              ?.map((e) =>
                  TvShowTopRatedModel.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
